...
authenticated. `dns-failed` never reached a connection, and a passthrough is relayed for the build
to judge rather than decrypted, so no certificate of Buildcage's was involved in either.
