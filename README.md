...
and no port. Under `inspect` that is the only trace of a name the build reached for and did not use,
which is how a rule wider than the build needs shows up. A name that was connected to has no such
