...
// moby's default seccomp profile with a few entries appended, regenerated by
// `make seccomp_profile`. Reformatting it would make the diff against upstream
// unreadable, which is the only way to review what the builder actually allows.
